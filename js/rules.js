...
export const BahrRule = {
  ...
  description: `
    ...
    <ul>
      ...
      <li>White's king stands <em>directly beside</em> the extra pawn.</li>
  ...
  isApplicable(pos) {
    ...
    if (chebyshev(pos.wKf, pos.wKr, pos.xFile, pos.xRank) !== 1) return false;  // (2) adjacent
    if (pos.wKr < pos.xRank) return false;  // (2) king must not be behind (below) the pawn
